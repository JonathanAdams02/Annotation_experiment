...
const baseURL = "https://f003.backblazeb2.com/file/Annotation-study";

// Folder name mapping from local to Backblaze
const folderMapping = {
    "Ambiguous_Person_negative_scene": "Ambiguous_Person_Negative_Scene",
    "Ambiguous_Person_negative_scene_outlined": "Ambiguous_Person_Negative_Scene_Annotated",
    "Ambiguous_Person_positive_scene": "Ambiguous_Person_Positive_Scene",
    "Ambiguous_Person_positive_scene_outlined": "Ambiguous_Person_Positive_Scene_Annotated",
    "Congruent Negative": "Congruent_Negative",
    "Congruent Negative_outlined": "Congruent_Negative_Annotated",
    "Congruent Positive": "Congruent_Positive",
    "Congruent Positive_outlined": "Congruent_Positive_Annotated",
    "Incongruent_Neg_Scene_Pos_People": "Incongruent_Neg_Scene_Pos_Person",
    "Incongruent_Neg_Scene_Pos_People_outlined": "Incongruent_Neg_Scene_Pos_Person_Annotated",
    "Incongruent_Pos_Scene_Neg_People": "Incongruent_Pos_Scene_Neg_Person",
    "Incongruent_Pos_Scene_Neg_People_outlined": "Incongruent_Pos_Scene_Neg_Person_Annotated"
};
        ...
        if (fs.statSync(folderPath).isDirectory() && folder !== '_multi_annotation') {
            ...
            files.forEach(file => {
                if (file.endsWith('.mp4')) {
                    // Use mapped folder name for URL
...
console.log(`Found ${allVideos.length} videos with corrected folder names!`);
