                ...
                function showQuestion() {
                    ...
                    if(questions[qIndex]!=='emotion'){
                        createVerderButton('Verder', ()=>{
                            if(questions[qIndex]==='setting'){
                                responses.setting_intensiteit = parseInt(document.getElementById('intensiteit-slider').value);
                                responses.setting_valentie = parseInt(document.getElementById('valentie-slider').value);
                            } else if(questions[qIndex]==='directness'){
                                responses.directness_rating = parseInt(document.getElementById('directness-slider').value);
                            }
                            nextQuestion();
                        });
                    }
    ...
    shuffledPairs.forEach((pair,index)=>{
        ...
        const personTrial = {
            ...
            on_load: function(){
                ...
                document.getElementById('person-intensiteit-slider').addEventListener('input',e=>window.currentPersonIntensiteit=parseInt(e.target.value));
                document.getElementById('person-valentie-slider').addEventListener('input',e=>window.currentPersonValentie=parseInt(e.target.value));
                createVerderButton('Verder', ()=>{
                    jsPsych.finishTrial({person_intensiteit:window.currentPersonIntensiteit, person_valentie:window.currentPersonValentie});
                });
            }
        };
