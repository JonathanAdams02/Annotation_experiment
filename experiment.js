...
function initializeExperiment() {
        ...
        if (type === 'setting') {
            content = `
                ...
                <h4>Examples of setting:</h4>
                    ...
                    <li><strong>Location:</strong> A beach, church, hospital, office</li>
                    <li><strong>Clothing:</strong> Formal suits, swimwear, mourning clothes</li>
                    <li><strong>Decoration:</strong> Balloons and confetti (party), flowers and candles (memorial)</li>
                    <li><strong>Items in the room:</strong> Furniture, objects, equipment</li>
            ...
            content = `
                ...
                <h4>Examples of personal characteristics:</h4>
                    ...
                    <li><strong>Facial expression:</strong> Smile, frown, tears, gaze</li>
                    <li><strong>Body language:</strong> Posture, gestures, body tension</li>
    ...
    const instructionsRound1 = {
        ...
        stimulus: `
            ...
            <p>For each video, you will rate:</p>
              ...
              <li><strong>Valence:</strong> How negative or positive the setting is (-3 to +3)</li>
              <li><strong>Intensity:</strong> How intense the setting is (0 to 6)</li>
              <li><strong>Directness:</strong> How direct the social interaction is (1 to 6)</li>
              <li><strong>Emotion:</strong> Select the main emotion from the emotion wheel</li>
              <li><strong>Ambiguity:</strong> How clear vs ambiguous the emotional content is (0 to 6)</li>
    ...
    // NEW: Detailed explanation of all rating scales
        ...
        stimulus: `
            <div style="max-width: 800px; margin: 0 auto; padding: 20px;">
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <p><strong>Direct interactions</strong> involve people actively communicating or engaging with each other through conversation, eye contact, physical contact, or coordinated activities (e.g., dancing together, playing a game, having a discussion).</p>
                    <p><strong>Indirect interactions</strong> involve people who are in the same setting or context but are not directly engaging with each other. They may be aware of each other's presence but are not actively communicating or interacting (e.g., people sitting separately in a waiting room, individuals in a crowd watching an event, people walking past each other).</p>
    ...
    // NEW: Detailed explanation of Person
    ...
    return `
        ...
        <div style="display:flex; height:100vh; width:100vw; padding:8px; box-sizing:border-box; gap:12px;">
          ...
          <!-- Questions Section -->
          <div style="flex:1; display:flex; flex-direction:column; justify-content:space-between; padding:10px; overflow:hidden; height:calc(100vh - 16px);">
            
            <!-- Top: Sliders (MORE compact) -->
            <div style="flex:0 0 auto;">
              <!-- Valence Slider -->
              <div style="margin-bottom:3px;">
                <div style="display:flex; align-items:center; gap:5px; margin-bottom:1px;">
                  <label style="font-weight:bold; font-size:11px;">Valence (setting only):</label>
                  <span class="info-icon" data-info="valence" style="cursor:help; font-size:12px; color:#007bff;">ⓘ</span>
                </div>
                <input type="range" min="-3" max="3" value="0" step="1" id="slider-valence" style="width:100%; height:15px;">
                ...
                <div style="text-align:center; font-size:9px; margin-top:0px;">
                  <span>Value: <strong id="valence-value">0</strong></span>
                </div>
              </div>
              ...
              <div style="margin-bottom:3px;">
                <div style="display:flex; align-items:center; gap:5px; margin-bottom:1px;">
                  <label style="font-weight:bold; font-size:11px;">Intensity (setting only):</label>
                  <span class="info-icon" data-info="intensity" style="cursor:help; font-size:12px; color:#007bff;">ⓘ</span>
                </div>
                <input type="range" min="0" max="6" value="0" step="1" id="slider-intensity" style="width:100%; height:15px;">
                <div style="display:flex; justify-content:space-between; font-size:8px; color:#666; margin-top:0px;">
                  <span>0</span><span>1</span><span>2</span><span>3</span><span>4</span><span>5</span><span>6</span>
                </div>
                <div style="text-align:center; font-size:9px; margin-top:0px;">
                  <span>Value: <strong id="intensity-value">0</strong></span>
                </div>
              </div>
              ...
              <div style="margin-bottom:3px;">
                <div style="display:flex; align-items:center; gap:5px; margin-bottom:1px;">
                  <label style="font-weight:bold; font-size:11px;">Directness (social interaction):</label>
                  <span class="info-icon" data-info="directness" style="cursor:help; font-size:12px; color:#007bff;">ⓘ</span>
                </div>
                <input type="range" min="1" max="6" value="1" step="1" id="slider-directness" style="width:100%; height:15px;">
                <div style="display:flex; justify-content:space-between; font-size:8px; color:#666; margin-top:0px;">
                  <span>1</span><span>2</span><span>3</span><span>4</span><span>5</span><span>6</span>
                </div>
                <div style="text-align:center; font-size:9px; margin-top:0px;">
                  <span>Value: <strong id="directness-value">1</strong></span>
                </div>
              </div>
            </div>

            <!-- Middle: Emotion Wheel (LARGER) -->
            <div style="flex:1 1 auto; display:flex; flex-direction:column; min-height:0; margin:3px 0; overflow:hidden;">
              ...
              <div id="div_svg" style="flex:1; width:100%; max-width:380px; margin:0 auto; position:relative; display:flex; align-items:center; justify-content:center; min-height:0;">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 715 725" preserveAspectRatio="xMidYMid meet" style="max-height:100%; display:block;">
                ...
                <div id="div_svg_lt_box" style="display:none;">
              ...
              <p id="emotion-status" style="text-align:center; font-size:9px; margin:2px 0 0 0;">
                <span id="emotion-selected" style="color:#666;">No emotion selected</span>
              </p>
            </div>
            ...
            <div style="flex:0 0 auto; margin-top:3px;">
              <div style="display:flex; align-items:center; gap:5px; margin-bottom:1px;">
                <label style="font-weight:bold; font-size:11px;">Ambiguity:</label>
                <span class="info-icon" data-info="ambiguity" style="cursor:help; font-size:12px; color:#007bff;">ⓘ</span>
              </div>
              <input type="range" min="0" max="6" value="0" step="1" id="slider-ambiguity" style="width:100%; height:15px;">
              <div style="display:flex; justify-content:space-between; font-size:8px; color:#666; margin-top:0px;">
                <span>0</span><span>1</span><span>2</span><span>3</span><span>4</span><span>5</span><span>6</span>
              </div>
              <div style="text-align:center; font-size:9px; margin-top:0px;">
                <span>Value: <strong id="ambiguity-value">0</strong></span>
              </div>
            </div>
...
`,
            ...
            on_load: function() {
             ...
             // Info icon hover handlers using mousemove (like emotion wheel)
...
document.querySelectorAll('.info-icon').forEach(icon => {
    ...
    icon.addEventListener('mousemove', function(e) {
        if (currentTooltip === this.dataset.info) {
            ...
            // Position logic similar to emotion wheel
    ...
    icon.addEventListener('mouseleave', function() {
        ...
        document.getElementById('info-tooltip').style.display = 'none';
                ...
                directnessSlider.addEventListener('input', function() {
                    document.getElementById('directness-value').textContent = this.value;
                ...
                ambiguitySlider.addEventListener('input', function() {
                    document.getElementById('ambiguity-value').textContent = this.value;
                ...
                if (responses.valence !== null) {
                    ...
                    document.getElementById('valence-value').textContent = responses.valence;
                    slidersTouched.valence = true;
                }
                if (responses.intensity !== null) {
                    intensitySlider.value = responses.intensity;
                    document.getElementById('intensity-value').textContent = responses.intensity;
                    slidersTouched.intensity = true;
                }
                if (responses.directness !== null) {
                    directnessSlider.value = responses.directness;
                    document.getElementById('directness-value').textContent = responses.directness;
                    slidersTouched.directness = true;
                }
                if (responses.ambiguity !== null) {
                    ambiguitySlider.value = responses.ambiguity;
                    document.getElementById('ambiguity-value').textContent = responses.ambiguity;
                    slidersTouched.ambiguity = true;
                }
    ...
    shuffledPairs.forEach((pair, index) => {
        ...
        const personTrial = {
                      ...
                      <div style="flex:1; display:flex; flex-direction:column; justify-content:center; padding:20px;">
                        ...
                        <div style="margin-bottom:20px;">
                          ...
                          <div style="text-align:center; font-size:13px; margin-top:5px;">
                            <span>Selected: <strong id="person-valence-value">0</strong></span>
                          </div>
                        </div>
                        ...
                        <div style="margin-bottom:20px;">
                          ...
                          <div style="text-align:center; font-size:13px; margin-top:5px;">
                            <span>Selected: <strong id="person-intensity-value">0</strong></span>
                          </div>
                        </div>
                      </div>
            ...
            on_load: function() {
                ...
                valenceSlider.addEventListener('input', function() {
                    document.getElementById('person-valence-value').textContent = this.value;
                    responses.valence = parseInt(this.value);
                    slidersTouched.valence = true;
                    checkAnswered();
                });
                ...
                intensitySlider.addEventListener('input', function() {
                    document.getElementById('person-intensity-value').textContent = this.value;
                    responses.intensity = parseInt(this.value);
                    slidersTouched.intensity = true;
                    checkAnswered();
                });
                ...
                if (responses.valence !== null) {
                    valenceSlider.value = responses.valence;
                    document.getElementById('person-valence-value').textContent = responses.valence;
                    slidersTouched.valence = true;
                }
                if (responses.intensity !== null) {
                    intensitySlider.value = responses.intensity;
                    document.getElementById('person-intensity-value').textContent = responses.intensity;
                    slidersTouched.intensity = true;
                }
